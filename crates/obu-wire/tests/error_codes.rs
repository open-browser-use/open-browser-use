use obu_wire::{
    ...
    error::{
        ERR_CAPABILITY_TOKEN, ERR_CDP_FAILURE, ERR_CMD_DISALLOWED, ERR_DISALLOWED, ERR_IO,
        ERR_NO_BACKEND, ERR_NOT_FOUND, ERR_NOT_IMPLEMENTED, ERR_OVERLOADED, ERR_PAGE_CLOSED,
        ERR_PEER_AUTH, ERR_PROTOCOL, ERR_TAB_NOT_ATTACHED, ERR_TIMEOUT,
    },
};
...
fn ranges_are_disjoint() {
    ...
    let backend = [ERR_PAGE_CLOSED, ERR_CDP_FAILURE, ERR_TAB_NOT_ATTACHED];
    for &code in &server {
